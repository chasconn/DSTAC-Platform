...
async function main() {
  console.log('› Creando tabla de evaluaciones Ley 21.719…')
  await centralDB.query(`
    CREATE TABLE IF NOT EXISTS ley21719_evaluaciones (
      ...
      certificado_emitido_at DATETIME NULL,
      created_by INT NULL,
  ...
  `)
  console.log('✓ Tabla ley21719_evaluaciones lista')
}
