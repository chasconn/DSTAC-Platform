...
app.use('/api/invitacion',      require('./routes/invitacion'))
...
app.use('/api/client/ordenes-compra', require('./routes/client/ordenes-compra'))
app.use('/api/client/equipo',         require('./routes/client/equipo'))
...
app.use('/api/admin/ordenes-compra',  require('./routes/admin/ordenes-compra'))
app.use('/api/admin/invitaciones',    require('./routes/admin/invitaciones'))
