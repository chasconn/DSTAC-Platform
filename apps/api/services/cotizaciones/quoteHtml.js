...
// Fecha límite de vigencia = fecha de emisión + validez_dias — una fecha
// concreta transmite más urgencia que un plazo relativo ("15 días").
...
.foot{margin-top:26px;border-top:1px solid #e2e0d8;padding-top:10px;font-size:10px;color:#888780;display:flex;justify-content:space-between}
  ...
  <div class="top">
    ...
    <div class="doc">
      <div class="t">COTIZACIÓN</div><div class="n">${esc(c.numero || '')}</div><div class="f">${fecha(c.fecha)}</div>
