      ...
      <table role="presentation" width="620" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:14px; overflow:hidden; max-width:620px; box-shadow:0 4px 24px rgba(26,21,48,0.08);">
        ...
        <tr>
          <td style="padding:34px 40px 0 40px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f9f8fc; border:1px solid #ece9f7; border-radius:14px;">
              <tr>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="64" style="vertical-align:top;">
                        <table role="presentation" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="width:54px; height:54px; background-image:linear-gradient(135deg, #7b4dff, #534AB7); border-radius:50%; text-align:center; vertical-align:middle; font-family:Arial, Helvetica, sans-serif; font-size:19px; font-weight:bold; color:#ffffff;">DC</td>
                          </tr>
                        </table>
                      </td>
                      <td style="vertical-align:middle; padding-left:16px;">
                        <p style="margin:0 0 2px 0; font-family:Arial, Helvetica, sans-serif; font-size:17px; font-weight:bold; color:#1a1530;">Diego Chacón</p>
                        <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:bold; color:#7b4dff;">DSTAC | DS Tactical Security</p>
                      </td>
                    </tr>
                  </table>

                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:18px;">
                    <tr><td style="border-top:1px solid #e3deF5; padding-top:16px;"></td></tr>
                  </table>

                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:4px;">
                    <tr>
                      <td width="33%" style="vertical-align:top; padding-top:4px;">
                        <a href="mailto:dchacon@dstac.cl" style="text-decoration:none;">
                          <span style="display:inline-block; width:26px; height:26px; line-height:26px; text-align:center; background-color:#ece7ff; border-radius:50%; font-size:13px; margin-right:6px; vertical-align:middle;">✉️</span>
                          <span style="font-family:Arial, Helvetica, sans-serif; font-size:12.5px; color:#1a1530; font-weight:bold; vertical-align:middle;">dchacon@dstac.cl</span>
                        </a>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="vertical-align:top;">
                        <a href="https://wa.me/56962198594" target="_blank" style="text-decoration:none;">
                          <span style="display:inline-block; width:26px; height:26px; line-height:26px; text-align:center; background-color:#ece7ff; border-radius:50%; font-size:13px; margin-right:6px; vertical-align:middle;">📞</span>
                          <span style="font-family:Arial, Helvetica, sans-serif; font-size:12.5px; color:#1a1530; font-weight:bold; vertical-align:middle;">+56 9 6219 8594 (WhatsApp)</span>
                        </a>
                      </td>
                    </tr>
                    <tr><td style="height:10px;"></td></tr>
                    <tr>
                      <td style="vertical-align:top;">
                        <a href="https://www.dstac.cl" target="_blank" style="text-decoration:none;">
                          <span style="display:inline-block; width:26px; height:26px; line-height:26px; text-align:center; background-color:#ece7ff; border-radius:50%; font-size:13px; margin-right:6px; vertical-align:middle;">🌐</span>
                          <span style="font-family:Arial, Helvetica, sans-serif; font-size:12.5px; color:#1a1530; font-weight:bold; vertical-align:middle;">dstac.cl</span>
                        </a>
                      </td>
                    </tr>
                  </table>
