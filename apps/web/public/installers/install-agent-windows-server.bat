...
if %errorlevel% neq 0 (
  ...
  powershell -NoProfile -Command ^
    "Start-Process powershell -ArgumentList ^"-NoProfile -ExecutionPolicy Bypass -Command `$env:WAZUH_ENROLL_PASSWORD='dc36d4d470f23469a0b8613dc62351a0'; ^& '%~dp0install-agent-windows-server.ps1'^\" -Verb RunAs"
  exit /b 0
)

REM Ya es admin — ejecutar el script con la clave seteada
powershell -NoProfile -Command "$env:WAZUH_ENROLL_PASSWORD='dc36d4d470f23469a0b8613dc62351a0'; & '%~dp0install-agent-windows-server.ps1'"
